...
const ContactUs = () => {
  return (
    <div>
      <div className="mx-auto mt-20 flex w-11/12 max-w-fit flex-col justify-between gap-10 text-white lg:flex-row">
      ...
      <div className="relative mx-auto my-20 flex w-11/12 max-w-fit flex-col items-center justify-between gap-8 bg-[#000814] text-white">
