...
const NavBar = ({ setProgress }) => {
    ...
    return (
      <div
        className={` flex sm:relative bg-[#000814] w-screen relative z-50 h-14 items-center justify-center border-b-[1px] border-b-richblack-700 translate-y-  transition-all duration-500`}
      >
        <div className="flex w-11/12 max-w-maxContent items-center justify-between">
          ...
          >
            ...
            <div ref={show} className="mobNav z-50">
              ...
              >
                ...
                {token != null && (
                  <div className=" mt-2">
                    <p className=" text-[#f1f2ff]0 text-center mb-2">Account</p>
                ...
                <div className=" flex flex-col items-end pr-4">
                  {sublinks?.length < 0 ? (
                    ...
                    sublinks?.map((element, index) => (
                      ...
                      >
                        <p className=" text-[#f1f2ff] ">{element?.name}</p>
                      </Link>
                    ))
                  )}
                </div>
                ...
                <Link
                  ...
                  className="p-2"
                >
                  <p className=" text-[#f1f2ff] ">Contact</p>
                </Link>
              </nav>
            </div>
          </div>
            ...
            <ul className=" flex-row gap-x-6 text-richblack-25 gap-5 hidden md:flex">
              ...
              >
                <input
                  ...
                  type="text"
                  placeholder="Search"
                  className=" absolute top-0 left-0 border-0 focus:ring-1 ring-richblack-400 rounded-full px-2 py-1 text-[15px] w-28 text-[#f1f2ff]0 focus:outline-none focus:border-transparent bg-richblack-700"
                />
                <HiSearch
                  type="submit"
                  id="searchicon"
          ...
          <div className="flex-row gap-5 hidden md:flex items-center">
            ...
            {token == null && (
              ...
              >
                <button className="rounded-[8px] border border-richblack-700 bg-[#161d29] px-[12px] py-[7px] text-richblack-100">
                  Login
                </button>
              </Link>
            )}
