      ...
      <div className="mx-auto w-11/12 max-w-[1000px] py-10">
        <div>
          ...
          <div className="my-4 flex flex-col-reverse  gap-3 md:flex-row md:flex md:h-[450px] md:space-x-4">
            <div className="flex flex-col flex-1 rounded-md bg-[#161d29] p-6">
                  ...
                  <button
                    ...
                    className={`px-2 py-2 rounded-md ${
                      currentChart === "revenue"
                        ? "bg-[#000814] text-yellow-100"
                        : "bg-[#161d29] text-richblack-100"
                    }`}
                  >
                    Revenue
                  </button>
        ...
        <div className="rounded-md bg-[#161d29] p-6">
          ...
          <div className="my-4 flex space-x-6">
            {courses?.length === 0 ? (
              <p className="text-sm font-medium text-[#838894]">
                  ...
                  <div key={index} className="w-1/3">
                    ...
                    <div className="mt-3 w-full">
                      ...
                      <div className="mt-1  md:space-x-2 md:flex">
                        ...
                        <p className="hidden md:block text-xs font-medium text-[#838894]">
                          |
                        </p>
                        <p className="text-xs font-medium text-[#838894]">
                          ₹ {course?.price}
