    ...
    <div>
      <div className=" flex-1 overflow-auto">
        <div className="mx-auto w-11/12 max-w-[1000px] py-10">
          ...
          {/* update profile picture */}
          <div className="flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-[#161d29] md:p-8 md:px-12 px-3 py-3 text-[#f1f2ff]">
              ...
              <div className="space-y-2">
                ...
                <form onSubmit={handleUpload}>
                  <div className="flex flex-row gap-3">
                    <label
                      className="cursor-pointer rounded-md bg-richblack-700 py-2 px-5 font-semibold text-[#f1f2ff]0'"
                      htmlFor="upload"
                    >
                      Select
                      <input
            ...
            <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-[#161d29] p-8 px-12">
              ...
              <div className="flex flex-col gap-5 lg:flex-row">
                <div className="flex flex-col gap-2 lg:w-[48%]">
                  <label htmlFor="firstName" className=" text-[#f1f2ff]0">
                    First Name
                  </label>
                  <input
                ...
                <div className="flex flex-col gap-2 lg:w-[48%]">
                  <label htmlFor="lastName" className="text-[#f1f2ff]0">
                    Last Name
                  </label>
                  <input
              ...
              <div className="flex flex-col gap-5 lg:flex-row">
                <div className="flex flex-col gap-2 lg:w-[48%]">
                  <label htmlFor="dateOfBirth" className="text-[#f1f2ff]0">
                    Date of Birth
                  </label>
                  <input
                ...
                <div className="flex flex-col gap-2 lg:w-[48%]">
                  <label htmlFor="gender" className="text-[#f1f2ff]0">
                    Gender
                  </label>
                  <select
              ...
              <div className="flex flex-col gap-5 lg:flex-row">
                <div className="flex flex-col gap-2 lg:w-[48%]">
                  <label htmlFor="contactNumber" className="text-[#f1f2ff]0">
                    Contact Number
                  </label>
                  <input
                ...
                <div className="flex flex-col gap-2 lg:w-[48%]">
                  <label htmlFor="about" className="text-[#f1f2ff]0">
                    About
                  </label>
                  <input
