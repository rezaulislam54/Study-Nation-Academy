...
const EnrolledCourses = () => {
    ...
    if (Loading) {
      return (
        <div className="flex h-[calc(100vh)] w-full justify-center items-center">
          <div className="animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-[#f1f2ff]00"></div>
        </div>
      );
    }
    ...
    return (
      <div className="mx-auto w-11/12 max-w-[1000px] py-10">
        <div className="text-3xl text-[#f1f2ff]0">Enrolled Courses</div>
        {!enrolledCourses ? (
          <div>Loading...</div>
          ...
          <div className="my-8 text-[#f1f2ff]">
            <div className="flex rounded-t-lg bg-[#f1f2ff]00 ">
              ...
              >
                <div className="flex w-[45%] cursor-pointer items-center gap-4 px-5 py-3">
                  ...
                  <div className="flex max-w-xs flex-col gap-2">
                    ...
                    <p className="text-xs text-[#838894] hidden md:block">
                      {
