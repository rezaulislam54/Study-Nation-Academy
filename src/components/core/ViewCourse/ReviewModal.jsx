...
const ReviewModal = ({setReviewModal}) => {
  ...
  return (
    <div>
      <div className=" z-50 my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-[#161d29] fixed left-[50%] top-[50%] -translate-x-1/2 -translate-y-1/2">
          ...
          >
            ...
            <div className="mt-6 flex w-11/12 justify-end gap-x-2">
              <button
                ...
                className="px-4 py-2 rounded-lg text-sm font-medium bg-[#838894]"
              >
                Cancel
              </button>
              <button
